...
(function() {
    ...
    function routesConfig($stateProvider, $locationProvider, $urlRouterProvider, helper){
        ...
        $stateProvider
          ...
          .state('app.modifyPrimaryStudies', {
                url: '/modifyPrimaryStudies',
                title: 'Modify Primary Studies',
    ...
    function DataTableController($resource, DTOptionsBuilder, DTColumnDefBuilder, $http) {
        ...
        function activate() {
          ...
          // Ajax
            $http({
                method: 'POST',
                url: 'server/primaryStudiesData/fetchPrimaryStudies.php',
                data: {data: 'getData'},
                headers: {'Content-Type': 'application/json'}
            }).then(function(data) {
